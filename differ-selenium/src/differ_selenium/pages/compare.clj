...
(defn wait-for-page []
  (wait-until #(exists? ((elements :image-01) :thumbnail)) 10000)
  (wait-until #(exists? ((elements :image-01) :histogram)))
  (wait-until #(exists? ((elements :image-02) :thumbnail)))
  (wait-until #(exists? ((elements :image-02) :histogram)))
  )
